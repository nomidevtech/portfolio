...
export default async function ResendCancelBookingEmail({ bookingPubId, adminPubId }) {
  ...
  return (<>
    <ClientResendCancelBookingEmail bookingPubId={bookingPubId} adminPubId={adminPubId} />
  </>);
}
